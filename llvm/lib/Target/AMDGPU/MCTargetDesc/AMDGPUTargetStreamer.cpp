...
StringRef AMDGPUTargetStreamer::getArchNameFromElfMach(unsigned ElfMach) {
  ...
  case ELF::EF_AMDGPU_MACH_AMDGCN_GFX926:  AK = GK_GFX926;  break;
  case ELF::EF_AMDGPU_MACH_AMDGCN_GFX928:  AK = GK_GFX928;  break;
  case ELF::EF_AMDGPU_MACH_AMDGCN_GFX936:  AK = GK_GFX936;  break;
...
unsigned AMDGPUTargetStreamer::getElfMach(StringRef GPU) {
  ...
  case GK_GFX926:  return ELF::EF_AMDGPU_MACH_AMDGCN_GFX926;
